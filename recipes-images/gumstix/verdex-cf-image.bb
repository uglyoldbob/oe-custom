DESCRIPTION = "A cf image for Gumstix verdex boards."
LICENSE = "MIT"

COMPATIBLE_MACHINE = "verdex"

WKS_FILE = "verdex-cf-image.wks"
IMAGE_FSTYPES += "wic"
...
#the verdex boots from flash
#u-boot can load and boot the kernel from the cf card
DEPENDS += "openocd verdex-bigflash-image"

inherit core-image
inherit simulator

#almost works with a cf image
#the sd argument actually specifies an mmc card on the verdex
SIMULATOR_ARGS += " -pflash ${DEPLOY_DIR_IMAGE}/verdex-bigflash-image.flash -sd ${DEPLOY_DIR_IMAGE}/${IMAGE_BASENAME}-verdex.wic"
